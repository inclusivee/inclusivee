  ...
  return (
    <>
      <div className="bg-cover bg-no-repeat bg-[url('/assets/image/bg-home.png')] h-screen w-full  flex justify-center items-center text-left ">
        ...
        <h1 className="text-4xl font-extrabold font-[Arial] mt-20 mb-10 opa">Você sabe o que é a inclusivee?</h1>
        <div className="mx-10">
        ...
        <p className="mb-5 text-left">Essa ferramenta facilitará o dia a dia das empresas e dos candidatos minorizados, garantindo um match com curadoria nas auto declarações,
         ...
         <Link href={'/pages/registryUser'}><Button className="bg-[#008037] text-white px-10 py-3 rounded-lg">Botão do Candidato</Button></Link> 
          ...
          <div className="flex flex-col justify-center items-center">
            <p className="mb-5 font-bold">Quero buscar candidatos para uma vaga:</p>
         <Link href={'/pages/registryUser'}><Button className="bg-[#008037] text-white px-10 py-3 rounded-lg">Botão da Empresa</Button></Link> 
          </div>
          <div className="flex flex-col justify-center items-center">
            <p className="mb-5 font-bold">Quero Cadastrar minha comunidade:</p>
         <Link href={'/pages/registryUser'}><Button className="bg-[#008037] text-white px-10 py-3 rounded-lg">Botão da Comunidade</Button></Link> 
          </div>
         </div>
        </section>
